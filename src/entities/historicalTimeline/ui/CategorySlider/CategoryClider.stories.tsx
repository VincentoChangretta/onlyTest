...
import { TimelineCategory } from 'entities/historicalTimeline/config/types/types';
...
const meta: Meta<typeof CategorySlider> = {
   ...
   parameters: {
      layout: 'fullscreen', // чтобы Swiper занимал всю ширину
   },
};
...
export const WithSecondCategory: Story = {
   decorators: [
      StoreDecorator({
         historicalTimeline: {
            index: 1,
